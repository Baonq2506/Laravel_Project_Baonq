...
@section('header')
    <section class="module bg-dark-60 blog-page-header" data-background="/images/a1.jpg"
    ...
    <section class="module">
        <div class="container">
            <div class="row multi-columns-row post-columns">
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="post">
                        <div class="post-thumbnail"><a href="#"><img src="/frontend/assets/images/post-2.jpg"
                                    alt="Blog-post Thumbnail"></a></div>
                        <div class="post-header font-alt">
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="post">
                        <div class="post-thumbnail"><a href="#"><img src="/frontend/assets/images/post-3.jpg"
                                    alt="Blog-post Thumbnail"></a></div>
                        <div class="post-header font-alt">
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="post">
                        <div class="post-thumbnail"><a href="#"><img src="/frontend/assets/images/post-4.jpg"
                                    alt="Blog-post Thumbnail"></a></div>
                        <div class="post-header font-alt">
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="post">
                        <div class="post-thumbnail"><a href="#"><img src="/frontend/assets/images/post-5.jpg"
                                    alt="Blog-post Thumbnail"></a></div>
                        <div class="post-header font-alt">
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="post">
                        <div class="post-thumbnail"><a href="#"><img src="/frontend/assets/images/post-6.jpg"
                                    alt="Blog-post Thumbnail"></a></div>
                        <div class="post-header font-alt">
